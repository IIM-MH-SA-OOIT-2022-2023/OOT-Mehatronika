...
public class DlgRGB extends JDialog {
	...
	public DlgRGB() {
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			lblCrvena.setFont(new Font("Tahoma", Font.BOLD, 16));
		...
		}
		{
			...
			textFieldCrvena.setHorizontalAlignment(SwingConstants.CENTER);
			GridBagConstraints gbc_textFieldCrvena = new GridBagConstraints();
			gbc_textFieldCrvena.gridwidth = 3;
			gbc_textFieldCrvena.insets = new Insets(0, 0, 5, 5);
		...
		}
		{
			...
			lblZelena.setFont(new Font("Tahoma", Font.BOLD, 16));
		...
		}
		{
			...
			textFieldZelena.setHorizontalAlignment(SwingConstants.CENTER);
			GridBagConstraints gbc_textFieldZelena = new GridBagConstraints();
			gbc_textFieldZelena.gridwidth = 3;
			gbc_textFieldZelena.insets = new Insets(0, 0, 5, 5);
		...
		}
		{
			...
			lblPlava.setFont(new Font("Tahoma", Font.BOLD, 16));
		...
		}
		{
			...
			textFieldPlava.setHorizontalAlignment(SwingConstants.CENTER);
			GridBagConstraints gbc_textFieldPlava = new GridBagConstraints();
			gbc_textFieldPlava.gridwidth = 3;
			gbc_textFieldPlava.insets = new Insets(0, 0, 0, 5);
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							if((r>=0 && r<=255) && (g>=0 && g<=255) && (b>=0 && b<=255)) {
								...
								JOptionPane.showMessageDialog(null, "Vrednosti moraju da budu u rasponu"
										+ " od 0 do 255",
										"Pogresan unos!", JOptionPane.WARNING_MESSAGE);
							}
							
						} catch (NumberFormatException e2) {
							JOptionPane.showMessageDialog(null, "Obavezan je unos brojeva!",
									"Pogresan unos!", JOptionPane.WARNING_MESSAGE);
						}
